...
<?php if ($license): ?><div class="alba-alert is-ok">Verified: <strong><?= $e($license['type']) ?></strong> licence.</div><?php endif ?>
<form method="post"><input type="hidden" name="_token" value="<?= $e($token) ?>">
  ...
  <?php endforeach ?>
  <div class="alba-actions"><button class="alba-btn">Verify licence</button></div>
</form>
