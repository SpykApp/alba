...
<?php foreach ($fields as $name => $f):
  ...
  <label class="alba-field"><span><?= $e($text($f['label'])) ?></span>
    ...
    <?php endif ?>
    <?php if ($f['help']): ?><em><?= $e($text($f['help'])) ?></em><?php endif ?>
    <?php if (isset($errors[$name])): ?><small class="alba-err"><?= $e($errors[$name]) ?></small><?php endif ?>
  </label>
<?php endforeach ?>
  <div class="alba-actions"><button class="alba-btn"><?= $e($t('ui.continue')) ?></button></div>
</form>
